...
# TextSplitter class to manage text chunking based on various split strategies
class TextSplitter:
    ...
    # recursive method to split text until it meets the chunk size constraints
    ...
    # method to merge splits into valid chunks while considering overlap
