...
class RAGAssistant:
    ...
    # Private method to generate chat responses using chat_stream
    ...
    # Private method to handle tool calls made during the conversation
    ...
    # Private method to process a single conversation step
    ...
    # Private method to manage the conversation task
